...
function menuMobileInit() {
  var mainMenu = $("header.header-main .main-menu__wrapper--menu").clone(true);
  var logo = $("header.header-main .main-menu__wrapper--logo").clone(true);
  var mobileMenu = $("header.header-main .slick-nav-wrapper");
...
function adjustLegendFormField() {
  ...
  $('form .hs-form-field').each(function () {
    let text = $(this).find('legend').text();
